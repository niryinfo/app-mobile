...
export default class Keypad extends Component {
    ...
    return (
      <View>
        <View style={_styles.wrapper}>
          <Text style={_styles.text_content}>{this.state.secrets.first}</Text>
          <Text style={_styles.text_content}>{this.state.secrets.second}</Text>
          <Text style={_styles.text_content}>{this.state.secrets.third}</Text>
          <Text style={_styles.text_content}>{this.state.secrets.fourth}</Text>
        </View>
        <View style={{marginTop: 20}}>
          <View style={_styles.pad_container}>
            <TouchableOpacity
              activeOpacity={0.4}
              style={_styles.pad_item}
              onPress={() => this.getVal(1)}>
              <Text style={_styles.pad_content}>1</Text>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.4}
              style={_styles.pad_item}
              onPress={() => this.getVal(2)}>
              <Text style={_styles.pad_content}>2</Text>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.4}
              style={_styles.pad_item}
              onPress={() => this.getVal(3)}>
              <Text style={_styles.pad_content}>3</Text>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.4}
              style={_styles.pad_item}
              onPress={() => this.getVal(4)}>
              <Text style={_styles.pad_content}>4</Text>
            </TouchableOpacity>
          </View>
          <View style={[_styles.pad_container, {marginTop: 15}]}>
            <TouchableOpacity
              activeOpacity={0.4}
              style={_styles.pad_item}
              onPress={() => this.getVal(5)}>
              <Text style={_styles.pad_content}>5</Text>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.4}
              style={_styles.pad_item}
              onPress={() => this.getVal(6)}>
              <Text style={_styles.pad_content}>6</Text>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.4}
              style={_styles.pad_item}
              onPress={() => this.getVal(7)}>
              <Text style={_styles.pad_content}>7</Text>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.4}
              style={_styles.pad_item}
              onPress={() => this.getVal(8)}>
              <Text style={_styles.pad_content}>8</Text>
            </TouchableOpacity>
          </View>
          <View style={[_styles.pad_container, {marginTop: 15}]}>
            <TouchableOpacity
              activeOpacity={0.4}
              style={_styles.pad_item}
              onPress={() => this.getVal(9)}>
              <Text style={_styles.pad_content}>9</Text>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.4}
              style={_styles.pad_item}
              onPress={() => this.getVal(0)}>
              <Text style={_styles.pad_content}>0</Text>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.4}
              style={_styles.pad_item}
        ...
        <Button
          ...
          style={{marginTop: 20}}
          onPress={() =>
            this.props.onSubmit(this.state.code, () => this.reset())
          }
  ...
  getVal(value) {
    let newVal = this.state.code;
    if (newVal.length < 4) {
      newVal = this.state.code.concat(value);
      this.setState({code: newVal});
      this.setSecretValue(newVal);
    }
  }
  clearVal() {
    let newVal = this.state.code;
    if (newVal.length > 0) {
      ...
      this.setState({code: newVal});
      this.clearSecretValue(newVal);
    }
  }
  clearSecretValue(value) {
    const _secrets = this.state.secrets;
    switch (value.length) {
      case 0:
        _secrets.first = null;
        break;
      case 1:
        _secrets.second = null;
        break;
      case 2:
        _secrets.third = null;
        break;
      case 3:
        _secrets.fourth = null;
        break;
      default:
        break;
    }
    this.setState({secrets: _secrets});
  }
...
const _styles = StyleSheet.create({
  ...
  text_content: {
    ...
    height: 40,
    borderWidth: 1,
    borderColor: colors.gray, //colorScheme === 'dark' ? colors.light : colors.dark,
    textAlign: 'center',
